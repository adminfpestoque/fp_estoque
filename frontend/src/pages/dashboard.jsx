          ...
          <section className="panel dashboard-performance-panel">
            ...
            <DataTable
              ...
              columns={[
                ...
                { key: "unit_cost", label: "Preço de custo por unidade", render: (row) => fmtMoney(row.unit_cost) },
                { key: "unit_sale_price", label: "Preço de venda por unidade", render: (row) => fmtMoney(row.unit_sale_price) },
